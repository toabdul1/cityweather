...
public class WeatherDetailActivity extends AppCompatActivity {
    ...
    TextView tv_wind, tv_hum, tv_pressure;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_hum = (TextView) findViewById(R.id.hum);
    ...
    private void generateUI(WeatherModel weatherModel) {
        ...
        tv_hum.setText(""+weatherModel.getMain().getHumidity());
        tv_pressure.setText(""+weatherModel.getMain().getPressure());
        tv_wind.setText(""+weatherModel.getWind().getSpeed()+" "+weatherModel.getWind().getDeg());
