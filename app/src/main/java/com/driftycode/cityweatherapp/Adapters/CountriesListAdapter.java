...
public class CountriesListAdapter extends RecyclerView.Adapter<CountriesListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mDesView.setText(citiesWeatherModels[position].getWeather()[0].getMain() + " " + citiesWeatherModels[position].getWeather()[0].getDescription());
    ...
    static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View v) {
            ...
            mDesView = v.findViewById(R.id.short_description3);
